...
def calculate_demographic_data(print_data=True):
    ...
    # 1. Berapa orang di setiap ras
    race_count = df['race'].value_counts()

    # 2. Rata-rata umur pria
    average_age_men = round(df[df['sex'] == 'Male']['age'].mean(), 1)

    # 3. Persentase orang dengan Bachelor's
    ...
    # Persentase gaji >50K untuk yang higher ed
    higher_education_rich = round((df[higher_education]['income'] == '>50K').mean() * 100, 1)

    # Persentase gaji >50K untuk yang lower ed
    ...
    # 8. Pekerjaan terpopuler di India untuk >50K
